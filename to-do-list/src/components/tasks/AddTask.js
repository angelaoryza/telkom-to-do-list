...
return (
    ...
    <div class="h-screen inline-block w-screen gap-y-6" style={{backgroundImage: `url(${background})` , backgroundSize:'cover'}}>
        <img class="relative left-0 top-0  w-1/6"src={book} alt="book" />
        <img class="absolute  right-56 top-0 w-1/6 "src={flower} alt="flower" />
        ...
        <img class="absolute bottom-0 left-0  w-1/5"src={cake} alt="cake"/>
        <img class="absolute bottom-0 right-0 w-1/5 "src={unicorn} alt="unicorn" />
        <img class="absolute  bottom-4 right-96 w-1/12 "src={plane} alt="plane" />
    </div>
)
}
